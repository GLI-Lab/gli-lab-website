      ...
      <div className="max-w-screen-2xl mx-auto bg-white">
        <div className="max-w-screen-lg mx-auto py-8 md:py-16 px-4 md:px-6 space-y-12 text-left">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="font-semibold">Q: 연구실에 언제 컨택하는 것이 가장 좋을까요?</p>
              <p>
              건국대 재학생의 경우 3학년 1학기, 타대생의 경우 대학원 원서 접수 전 방학 시기가 가장 이상적입니다. 
              다만 정해진 시기가 있는 것은 아니므로, 관심이 생겼을 때 언제든 편하게 연락 주시면 됩니다. 
              한 가지 참고하실 점은, 본인에게 맞는 연구 주제를 탐색하고 구체화하는 데에는 생각보다 오랜 시간이 걸립니다. 
              그래서 가능하다면 일찍 컨택하여 스터디와 멘토링을 통해 관심 분야를 미리 탐색해 보는 것을 권장합니다.
              </p>
            </div>
