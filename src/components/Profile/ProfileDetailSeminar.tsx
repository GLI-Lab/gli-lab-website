...
import { formatSeminarTitlePlain } from '@/lib/seminarTitle';
            ...
            <div className="grid gap-x-4 gap-y-1">
                ...
                <div>
                    {visibleSeminars.map((seminar, index) => (
                        <div key={`${seminar.date}-${seminar.title}`} className="mb-2 leading-snug">
                            <div className="grid grid-cols-[1fr,auto] gap-x-4 items-start">
                                <div className="flex items-start min-w-0">
                                    ...
                                    <Link
                                        ...
                                        className="min-w-0 text-[14.5px] md:text-[15.5px] hover:text-interactive-hover hover:underline underline-offset-4"
                                        title="View in seminar page"
                                    >
                                        {formatSeminarTitlePlain(seminar.title)}
                                    </Link>
                                </div>
