...
export const ProfileDetail: React.FC<ProfileDetailProps> = (props) => {
    const {id, title, name_en, name_ko, admission, joined_start, joined_end, bs, ms, phd, photo, email, interest, current_work, homepage, github, linkedin, graduation, affiliation, studies = [], papers = [], isAlumniPage = false } = props;
    ...
    return (
        <div className=" bg-white flex flex-col items-center justify-center">
            ...
            <div className="w-full pt-3 text-[16px] md:text-[17px]">
                ...
                {/* Research Interests와 Current Work 섹션 - alumni가 아닌 경우에만 표시 */}
                {!isAlumniPage && (interest.length > 0 || current_work.length > 0) && (
                    <>
